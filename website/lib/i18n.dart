class WebsiteI18n {
  static const Map<String, Map<String, String>> _strings = {
    'ru': {
      ...
      'col_param': 'Параметр',
      'col_peekit': 'Peekit v1.2.0',
      'col_msstore': 'QuickLook',
      'col_powertoys': 'PowerToys Peek',

      'param_tech': 'Технологический стек',
      'param_tech_peekit': 'Rust + Tauri v2 + Svelte 5',
      'param_tech_ql': 'C# / .NET / WPF',
      'param_tech_pt': 'C++ / WinUI 3 (в составе PowerToys)',

      'param_ram_idle': 'Потребление ОЗУ в фоне',
      'param_ram_idle_peekit': '10–15 МБ',
      'param_ram_idle_ql': '30–50 МБ',
      'param_ram_idle_pt': '100–200 МБ',

      'param_ram_active': 'ОЗУ при активном просмотре',
      'param_ram_active_peekit': '~25–80 МБ (в зависимости от плагина)',
      'param_ram_active_ql': '~60–80 МБ (текст) / 150–300 МБ (PDF, медиа)',
      'param_ram_active_pt': '120–250 МБ',

      'param_speed': 'Холодный отклик по Space',
      'param_speed_peekit': '~ 50 мс',
      'param_speed_ql': '~50–80 мс',
      'param_speed_pt': '~200–350 мс',

      'param_size': 'Размер дистрибутива',
      'param_size_peekit': '~3.4 МБ (установщик) / 5.1 МБ (portable)',
      'param_size_ql': '~90 МБ',
      'param_size_pt': '>200МБ (весь пакет PowerToys)',

      'param_plugins': 'Архитектура плагинов',
      'param_plugins_peekit': 'Изолированные Web-песочницы (iframe + postMessage)',
      'param_plugins_ql': '.NET скомпилированные DLL',
      'param_plugins_pt': 'Отсутствует',

      'param_admin': 'Права администратора',
      'param_admin_peekit': 'Не требуются (чистый HKCU)',
      'param_admin_ql': 'Не требуются',
      'param_admin_pt': 'Требуются частично',
    ...
    'en': {
      ...
      'param_tech': 'Technology stack',
      'param_tech_peekit': 'Rust + Tauri v2 + Svelte 5',
      'param_tech_ql': 'C# / .NET / WPF',
      'param_tech_pt': 'C++ / WinUI 3 (part of PowerToys)',

      'param_ram_idle': 'Background RAM usage',
      'param_ram_idle_peekit': '10–15 MB',
      'param_ram_idle_ql': '30–50 MB',
      'param_ram_idle_pt': '100–200 MB',

      'param_ram_active': 'Active preview RAM',
      'param_ram_active_peekit': '~25–80 MB (depending on plugin)',
      'param_ram_active_ql': '~60–80 MB (text) / 150–300 MB (PDF, media)',
      'param_ram_active_pt': '120–250 MB',

      'param_speed': 'Cold response on Space',
      'param_speed_peekit': '~ 50 ms',
      'param_speed_ql': '~50–80 ms',
      'param_speed_pt': '~200–350 ms',

      'param_size': 'Distribution size',
      'param_size_peekit': '~3.4 MB (installer) / 5.1 MB (portable)',
      'param_size_ql': '~90 MB',
      'param_size_pt': '>200MB (full PowerToys suite)',

      'param_plugins': 'Plugin architecture',
      'param_plugins_peekit': 'Isolated Web sandboxes (iframe + postMessage)',
      'param_plugins_ql': '.NET compiled DLLs',
      'param_plugins_pt': 'None',

      'param_admin': 'Administrator rights',
      'param_admin_peekit': 'Not required (clean HKCU)',
      'param_admin_ql': 'Not required',
      'param_admin_pt': 'Partially required',
